...
airflow connections add --conn-host localhost --conn-type postgres --conn-login dedp_test --conn-schema dedp --conn-password dedp_test --conn-port 5432 docker_postgresql
