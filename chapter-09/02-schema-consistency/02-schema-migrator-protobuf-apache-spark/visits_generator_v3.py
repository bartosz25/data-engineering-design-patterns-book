...
from protobuf_output.python.definitons import visit_v3_pb2

if __name__ == '__main__':
    def visit(event_time: datetime, visit_id='id_1', page='home', user_id='user_1'):
        visit_to_write = visit_v3_pb2.VisitV3()
        ...
        visit_to_write.referral = visit_to_write.from_page
        visit_to_write.user_details.id = user_id
        visit_to_write.user_details.ip = visit_to_write.ip
        visit_to_write.user_details.login = visit_to_write.login
        visit_to_write.user_details.is_connected = visit_to_write.is_connected
