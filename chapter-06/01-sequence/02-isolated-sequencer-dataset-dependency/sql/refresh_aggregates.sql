...
-- Rerunning will lead to counting multiple times for the same new_devices_table_name
...
--FROM (
--    SELECT type, full_name, version, COUNT(*) AS all_occurrences FROM new_devices_table_name  GROUP BY type, full_name, version
--) AS new_devices
