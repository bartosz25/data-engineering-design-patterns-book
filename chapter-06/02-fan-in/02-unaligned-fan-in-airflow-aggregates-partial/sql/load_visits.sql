...
DELETE FROM dedp.visits_raw WHERE execution_time_id = '{{ ds }}' AND execution_time_hour_id = '{{ params.hour }}';

INSERT INTO dedp.visits_raw (execution_time_id, execution_time_hour_id, user_id, page)
