...
if __name__ == '__main__':
    ...
    visits = spark_session.createDataFrame(data=[
        Row(user_id=3, visit_time=datetime.datetime.now(tz=datetime.timezone.utc), page='page_1.html'),
        Row(user_id=4, visit_time=datetime.datetime.now(tz=datetime.timezone.utc), page='page_2.html')
    ])
