...
if __name__ == "__main__":
    ...
    write_query = (visits.writeStream
                   ...
                   .option('checkpointLocation',
                           '/tmp/dedp/ch10/02-time-detectors/01-lag-detector-apache-spark-apache-kafka-grafana/checkpoint')
                   .outputMode('append').foreachBatch(write_to_delta_table).start())


    spark_session.streams.addListener(BatchCompletionSlaListener(bootstrap_servers='localhost:9094', topic='visits'))
